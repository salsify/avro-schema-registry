...
The service is implemented as a Rails 8.1 application and stores Avro schemas in
...
The application is written using Ruby 3.4.10. Start the service using the following
steps:
