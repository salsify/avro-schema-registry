...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "avro_schema_registry_#{Rails.env}"
  ...
  config.x.app_password = ENV.fetch('SCHEMA_REGISTRY_PASSWORD') unless config.x.disable_password
