describe SchemaRegistry do
  ...
  describe ".compatible?" do
    ...
    context "server error" do
      ...
      let(:old_json) do
        { type: 'record', name: 'event', namespace: 'com.salsify.identity', fields: [{ name: 'attribute', type: { type: 'record', name: 'reference', namespace: 'com.salsify', fields: [{ name: 'id', type: 'string' }, { name: 'type', type: 'string' }] } }] }.to_json
      end

      let(:new_json) do
        { type: 'record', name: 'event', namespace: 'com.salsify.identity', fields: [{ name: 'attribute', type: ['null', { type: 'record', name: 'reference', namespace: 'com.salsify', fields: [{ name: 'id', type: 'string' }, { name: 'type', type: 'string' }] }], default: nil }] }.to_json
      end
